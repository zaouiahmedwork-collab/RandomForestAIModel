...
2.have pandas installed (run this command on a terminal to install) (git installed on your machine is needed) : pip install pandas)  
...
1.or simply download the project as Zip then extract if the 2 privious steps was tough to execute
